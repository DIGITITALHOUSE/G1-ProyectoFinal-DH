...
export const ListCategories = () => {
    ...
    const API_URL = "http://localhost:8081/space-type";
        ...
        },
        {
            ...
            cell: (row) => (
                <div className="flex">
                    ...
                    <button onClick={() => showMessage("confirm", "¿Está seguro de eliminar esta categoría?", () => deleteProducts(row.id))}
            ...
            <div>
                <div className="flex flex-col px-4">
                    <div className="mt-4 mb-4 p-4">
                        <div className="flex">
                            <div className="text-2xl font-bold mr-5">Listado Categorías</div>
                            <Link to="/categories">
